...
class Tipo_Habitacion(Base):
    ...
    usuario_crea = relationship("Usuario", foreign_keys=[id_usuario_crea], back_populates="tipos_habitacion_creados")
    usuario_edita = relationship("Usuario", foreign_keys=[id_usuario_edita], back_populates="tipos_habitacion_editados")
